...
export class DashboardComponent implements OnInit, OnDestroy {
  private marketStreamSubscription?: Subscription;
  positions: Position[] = [];
  orders: Order[] = [];
...
startMarketStream(): void {
  ...
  this.marketStreamSubscription?.unsubscribe();

  this.marketStreamSubscription =
    this.marketStreamService.streamQuote(normalizedSymbol).subscribe({
      next: (quote) => {
        this.quote = quote;
      },
      error: (err) => {
